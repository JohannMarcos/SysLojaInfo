...
{
    internal class daoFornecedores : dao
    {
        ...
        public override void salvar(object obj)
        {
            ...
            string oSql = @"insert into Fornecedores (nome, cpfCnpj, rg, logr, num, natPes, bairro, fk_cidade,
                            telres, telcel, email, fk_condPag, datCad, datAlt, idUser) values (@nome, @cpfCnpj, @rg, @logr, 
                            @num, @nat, @bairro, @fkCidade, @telRes, @telcel, @em, @cond, @datCad, @datUltAlt, @id_user)";
            ...
            try
            {
                ...
                execCmd.Parameters.AddWithValue("@cond", oFornecedor.aCond.Codigo);
        ...
        public override void editar(object obj)
        {
            ...
            string oSql = @"update Fornecedores SET nome = @nome, cpfCnpj = @cpfCnpj, rg = @rg, logr = @logr, num = @num,
                            ...
                            telcel = @telcel, email = @em, fk_CondPag = @cond, datAlt = @datUltAlt, idUser = @id_user where idForn =  @Cod";
            oFornecedor.DatUltAlt = DateTime.Now;
            oFornecedor.QuemAlter = 0;
