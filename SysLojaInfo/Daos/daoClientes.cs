...
{
    internal class daoClientes : dao
    {
        ...
        public override void salvar(object obj)
        {
            ...
            string oSql = @"insert into Clientes (nome, cpfCnpj, rg, logr, num, natPes, bairro, limCred, fk_cidade,
                            telres, telcel, email,fk_condPag, datCad, datAlt, idUser) values (@cliente, @cpfCnpj, @rg, @logr, 
                            @num, @nat, @bairro, @limCred, @fkCidade, @telRes, @telcel, @em, @cond, @datCad, @datUltAlt, @id_user)";
            ...
            try
            {
                ...
                execCmd.Parameters.AddWithValue("@cond", oCliente.aCond.Codigo);
        ...
        public override void editar(object obj)
        {
            ...
            string oSql = @"update Clientes SET nome = @cliente, cpfCnpj = @cpfCnpj, rg = @rg, logr = @logr, num = @num,
                            ...
                            telcel = @telcel, email = @em, fk_CondPag = @cond, datAlt = @datUltAlt, idUser = @id_user where idCliente =  @Cod";
            oCliente.DatUltAlt = DateTime.Now;
            oCliente.QuemAlter = 0;
        ...
        public List<Clientes> SelecionaDS()
        {
            ...
            ctrlCondPag CtrlCondPag = new ctrlCondPag();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    Clientes item = new Clientes()
                    {
                        ...
                        aCond = CtrlCondPag.buscar(Convert.ToInt32(reader["fk_condPag"])),
        ...
        public Clientes buscar(string str)
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    item.aCond = CtrlCondPag.buscar(Convert.ToInt32(reader["fk_condPag"]));
