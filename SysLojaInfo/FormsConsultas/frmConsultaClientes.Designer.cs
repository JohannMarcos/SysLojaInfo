namespace SysLojaInfo
{
    partial class frmConsultaClientes
    {
        ...
        private void InitializeComponent()
        {
            ...
            dgClientes.Columns.AddRange(new DataGridViewColumn[] { codigo, nome, cpfcnpj, rg, logr, num, natpess, bairro, limcred, codcidade, cidade, telres, telcel, email, codCond, condicao, datcad, datalt, iduser });
            ...
            codCond.HeaderText = "Cod. Condição";
